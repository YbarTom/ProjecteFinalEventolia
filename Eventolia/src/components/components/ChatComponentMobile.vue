<template>
    <div class="container">
        <div class="list-container">
            <div class="users">
                <UserChat v-if="!isChatVisible" v-for="(chat, index) in myChats" :key="index" :buttonText="chat.users[0]"
        ...
        <div class="input-container"
            ...
            <button v-if="isChatVisible" @click="closeChat" class="buttonCerrar bg-principal2">Cerrar</button>
            <ul>
